...
def generate_concordance(body_lines, exclusion_words):
        
        body_lines_capped = create_capped_body_lines(body_lines, exclusion_words)
...
def main ():
    ...
    generate_concordance(body_lines_raw, exclusion_words_lower)
